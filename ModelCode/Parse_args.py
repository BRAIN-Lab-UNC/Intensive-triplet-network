...
parser.add_argument('--latent_dim', type=int, default=6000, help='dimensionality of the latent space')
parser.add_argument('--noiseSize', type=int, default=200, help='latent noise dimension')
parser.add_argument('--ageSize', type=int, default=200, help='latent age dimension')
parser.add_argument('--FC_path', type=str, default='ROI70\ROI70_FC_AP', help= 'FC stored path')
parser.add_argument('--age_group',type=list, default=[0,1,2,3,4,5],help='group of age, 0 means 0-29 days, 1 means 30-59 days, etc..')
parser.add_argument('--sigma', type=float, default=0.3, help='aging module coincidence rate') # 0.1 0.5
...
parser.add_argument('--MultiTimeSubFile', type=str, default='ROI70\mul_time_subjects_AP.txt', help='The file that stores subjects with multiple timepoints')

parser.add_argument('--ROI_num', type=int, default=68, help='ROI Number')

parser.add_argument('--TestSubs', type=int, default=5, help='Testing Subjects Number')
